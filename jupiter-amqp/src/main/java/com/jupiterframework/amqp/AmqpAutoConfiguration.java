...
import com.jupiterframework.amqp.handler.impl.AmqpHandlerServiceImpl;
...
public class AmqpAutoConfiguration {
	...
	@Bean
	@ConditionalOnBean({ AmqpHandlerService.class })
	public AmqpTransactionListener amqpTransactionListener(AmqpTemplate amqpTemplate, AmqpHandlerService handler) {
		return new AmqpTransactionListener(amqpTemplate, handler);
	}
	...
	@Bean
	public AmqpHandlerService amqpHandlerService() {
		return new AmqpHandlerServiceImpl();
	}
