...
public class SequenceDefinitionController {
	...
	@GetMapping("/batch")
	public List<String> generators(@RequestParam("TenantId") String tenantId, @RequestParam("seqName") String seqName,
	...
	@PostMapping
	public PageResult<SequenceDefinition> selectPage(@Valid @RequestBody PageQuery<SequenceDefinition> query) {
