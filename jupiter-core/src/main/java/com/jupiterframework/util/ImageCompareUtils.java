...
public final class ImageCompareUtils {
    ...
    public ImageCompareUtils(byte[] hashValue) {
    ...
    public ImageCompareUtils(String hashValue) {
        this(toBytes(hashValue));
    }


    public ImageCompareUtils(BufferedImage src) {
        this(hashValue(src));
    }
    ...
    /**
     * 从压缩格式指纹创建{@link ImageCompareUtils}对象
     * 
     * @param compactValue
     * @return
     */
    public static ImageCompareUtils createFromCompact(byte[] compactValue) {
        return new ImageCompareUtils(uncompact(compactValue));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ImageCompareUtils) {
            return Arrays.equals(this.binaryzationMatrix, ((ImageCompareUtils) obj).binaryzationMatrix);
        } else
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + Arrays.hashCode(binaryzationMatrix);
        return result;
    }
    ...
    public float compare(String hashValue) {
        return compare(new ImageCompareUtils(hashValue));
    }
    ...
    public float compare(BufferedImage image2) {
        return compare(new ImageCompareUtils(image2));
    }
     ...
     */
    public float compare(ImageCompareUtils src) {
    ...
    public static float compare(BufferedImage image1, BufferedImage image2) {
        return new ImageCompareUtils(image1).compare(new ImageCompareUtils(image2));
    }
