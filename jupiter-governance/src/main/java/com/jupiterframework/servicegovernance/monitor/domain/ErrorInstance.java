...
public class ErrorInstance implements Serializable {
	...
	public ErrorInstance(int code, String message, String exceptionDetail, String uri) {
		...
		hostAndPort = String.format("%s:%s", System.getProperty(ServiceGovernanceConstants.ADDRESS_NAME),
			System.getProperty(ServiceGovernanceConstants.SERVER_PORT_NAME));
	}
