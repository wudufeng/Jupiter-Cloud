...
public class ExceptionConverter {
    ...
    /** 系统级异常 */
    public ServiceFailureResponse buildServiceFailureResponse(SysRespCodeEnum sysResp, String exceptionClass, Throwable e) {
        ...
        sr.setStackTrace(e != null ? ExceptionUtils.getCauseMessage(e) : "");
        return sr;
    }
    ...
    private ServiceFailureResponse buildServiceFailureResponse() {
        ...
        sr.setPath(ServiceContext.getRemoteServiceCode() == null ? ServiceContext.getServiceCode() : ServiceContext.getRemoteServiceCode());
