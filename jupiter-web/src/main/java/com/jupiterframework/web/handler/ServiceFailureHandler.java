...
public class ServiceFailureHandler implements ErrorController {
    ...
    public ServiceFailureResponse validationError(HttpServletResponse response,
    ...
    public ServiceFailureResponse handleError(HttpServletRequest request, HttpServletResponse response) {
        ...
        default:
            ...
            if (t != null)
                ...
                sr = exceptionConverter.buildServiceFailureResponse(SysRespCodeEnum.UNKNOW_ERR,
                    String.valueOf(status), t);
        }
